    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Coverage Map Based on Payload
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <script>
                            ...
                            <?php
                            foreach ($cpayload as $data) {
                            ?>
                                // Variable for getColor function
                                var recom = [<?php echo json_encode($data['recommended_payload']); ?>];
                                ...
                                var jsonTest = new L.GeoJSON.AJAX(["<?= base_url(); ?>/assets/plugins/leaflet/geojson/<?= $data['geojson'] ?>"], {
                                    onEachFeature: function popUp(f, l) {
                                        ...
                                        out.push("Payload: " + "<?= round($data['payload_MB'], 3) ?>" + " MB");
                                        out.push("Recommended: " + "<?= $data['recommended_payload'] ?>");
